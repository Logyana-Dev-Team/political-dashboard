...
const AamcheKarya = React.lazy(() =>
  import("./components/AamcheKarya/AamcheKarya")
);
const AamchiMahiti = React.lazy(() =>
  import("./components/AamchiMahiti/AamchiMahiti")
);
const Sampark = React.lazy(() => import("./components/Sampark/Sampark"));
const Gallery = React.lazy(() => import("./components/Gallery/Gallery"));
const Jobs = React.lazy(() => import("./components/Jobs/Jobs"));
const TakrarNivaran = React.lazy(() =>
  import("./components/TakrarNivaran/TakrarNivaran")
);
...
const routes = [
  ...
  { path: "/takrar", exact: true, name: "Takrar", component: Takrar },
  {
    ...
    exact: true,
    name: "AamchiMahiti",
    component: AamchiMahiti,
  },
  {
    path: "/aamchekarya",
    exact: true,
    name: "AamcheKarya",
    component: AamcheKarya,
  },
